...
<body>
  ...
  <section>
    ...
    <!-- Imagen añadida -->
    <img src="../Multimedia/Imagenes/figuras_ninos.png" alt="Niños con figuras geométricas" style="display:block; margin: 10px auto; max-width: 300px; border-radius: 10px;">
